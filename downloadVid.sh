...
{
        chat_downloader --cookies /app/cookies.txt -o "$output.live_chat.json" "https://www.youtube.com/watch?v=$1" || echo "Error downloading chat for $1"
        ...
        # May not be needed for chat_downloader
