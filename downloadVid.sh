...
{
        chat_downloader --cookies /app/cookies.txt --logging error -o "$output.live_chat.json" "https://www.youtube.com/watch?v=$1" || \
chat_downloader --logging error -o "$output.live_chat.json" "https://www.youtube.com/watch?v=$1"
